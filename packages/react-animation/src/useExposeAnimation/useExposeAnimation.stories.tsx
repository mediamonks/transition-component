...
export function UseExposeAnimation(): ReactElement {
...
export const UseExposeAnimationForwardRef = ensuredForwardRef<HTMLDivElement, unknown>(
  (_, ref): ReactElement => {
    const animation = useAnimation(() => gsap.from({ value: 0 }, { value: 1 }), []);
    useExposeAnimation(animation, ref);
...
export function UseExposeAnimationStringReference(): ReactElement {
